 ...
 * @author STUDENT
 */
public class Login_Clerk extends javax.swing.JFrame {
     Connection con;
     Statement st;
    ResultSet rs;
    /**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Click Here For Clerk Login");
        jLabel3.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
...
catch(Exception e)
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Login_Clerk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Login_Clerk().setVisible(true);
            }
        });
    }
